 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://tycs/", wsdlLocation = "http://localhost:8080/Pract2Calculatorws/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://tycs/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Pract2Calculatorws/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://tycs/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tycs/", "CalculatorPort"), Calculator.class, features);
    }
