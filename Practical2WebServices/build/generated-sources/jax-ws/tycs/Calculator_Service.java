 ...
 * 
 */
@WebServiceClient(name = "Calculator", targetNamespace = "http://ty/", wsdlLocation = "http://localhost:8080/Practical2WebServices/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATOR_QNAME = new QName("http://ty/", "Calculator");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Practical2WebServices/Calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://ty/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ty/", "CalculatorPort"), Calculator.class, features);
    }
